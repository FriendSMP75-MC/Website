    ...
    if (user == null) {
      return Scaffold(
        ...
        body: Container(
          ...
          child: const Center(
            child: Text('Login required to access gallery request approvals.'),
          ),
        ),
      );
    }
          ...
          children: [
                ...
                children: [
                  PopupMenuButton<String>(
                    ...
                    child: _buildMenuTrigger(
                      ...
                      label: 'Status: ${_statusSortLabel(_selectedStatusSort)}',
                      width: 180,
                    ),
                  ),
                  PopupMenuButton<String>(
            ...
            if (_isLoadingRequests)
              ...
              ...visibleRequests.map((request) {
                ...
                final canDelete = status != 'pending' && !_isDeletingRequest;
                          ...
                          Row(
                            children: [
                              ...
                              OutlinedButton.icon(
                                ...
                                label: Text(
                                  _isDeletingRequest ? 'Deleting...' : 'Delete',
                                  style: TextStyle(
                                    color: canDelete
                                        ? Colors.red.shade300
                                        : Colors.grey,
